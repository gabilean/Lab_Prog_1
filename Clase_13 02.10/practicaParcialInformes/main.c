...
int main()
{
    ...
    pantalla_altaForzada(array,QTY,"Bernal","Belgrano 250",2000,0);
    pantalla_altaForzada(array,QTY,"Bosco","Cerrito 300",2000,0);
    pantalla_altaForzada(array,QTY,"Quilmes","Lavalle 450",2,1);
    ...
    do
    {
        ...
        switch(menu)
        {
            ...
            case 5:
                ...
                printf("\n1. Por precio y nombre");
                printf("\n2. Pantalla/s con valor menor o igual a 10");
                printf("\n3. Pantalla/s con valor mayor a 10");
                printf("\n4. Pantalla/s con valor mayor al promedio");
                printf("\n5. Pantalla/s con valor menor al promedio");
                printf("\n6. Clientes por contratacion");
                printf("\n\nOpcion: ");
                ...
                {
                    case 1:
                        informar_ordenarNameNPrice(array, QTY);
                        pantalla_mostrar(array,QTY);
                        break;

                    case 2:
                        informar_ordenarLess10(array, QTY);
                        break;

                    case 3:
                        informar_ordenarMore10(array,QTY);
                        break;

                    case 4:
                        informar_moreThanAverage(array, QTY);
                        break;

                    case 5:
                        informar_lessThanAverage(array, QTY);
                        break;

                    case 6:
                        informar_contPerClients(array, contrataciones, cuit, QTY);
                        break;
